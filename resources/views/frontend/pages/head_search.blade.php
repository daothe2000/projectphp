          ...
          <form class="search-box-inner" action="{{ route('head_search') }}" method="get">
            ...
            <div class="row product">
              ...
              <div class="col-lg-4 col-sm-12 get-item">
                <div class="pro1">
                  <div class="img-pro">
                    <a href="{{route('product_detail',['id'=>$s->id])}}"><img src="{{asset('public/frontend/imgs/'.$s->image)}}" alt=""></a>
                  </div>

                  <div class="text-pro">
                    <a href="{{route('product_detail',['id'=>$s->id])}}"><p>{{$s->pro_name}}</p></a>

                    <p>{{$s->cat->name}}</p>

                    <strong>{{number_format($s->price)}}đ</strong>
                  </div>
                  <div class="cart">
                   <a  data-url="{{route('add-cart',['id'=>$s->id])}}" class="add-cart2"> <button class="btn">ADD TO CART<i class="fas fa-plus text-center"></i></button></a>
                 </div>
               </div>
             </div>
             @endforeach
         ...
         <div class="col-lg-3 col-md-6 col-sm-12 sirbar-1 ">
          ...
          <div class="shop-sidebar shop-sidebar-12 mb-30">
            ...
            <div class="filter-price-content">
              <form action="{{route('head_search')}}" method="get">
